...
const ExportSubcityDialog = ({ subcity_id }: { subcity_id: number }) => {
  const formatOptions = [
    {
      value: 'csv',
      label: 'CSV',
  ...
  const handleExport = async () => {
    setIsExporting(true);
    try {
      await reportExportApi.subcityExport(format, subcity_id.toString());
...
export default ExportSubcityDialog;
